...
class Address(Base):
	...
	addressID = Column('addressID', Integer(15), primary_key=True) #autoincr automatic? 
...
class LogInformation(Base):
	...
	addressID = Column('addressID', Integer(15), ForeignKey("Address.addressID"), nullable=False)
...
class Product(Base):
	...
	quantity = Column('quantity', Integer(30), nullable=False)
...
class Warehouse(Base):
	...
	warehouseID = Column('warehouseID', Integer(20), primary_key=True)
	warehouseOwner = Column('warehouseOwner', String(50), ForeignKey("LogInformation.email"), nullable=False)
	description = Column('description', String(100))
	capacity = Column('capacity', Integer(30))
	addressID = Column('addressID', Integer(15), ForeignKey("Address.addressID"), nullable=False)

class WarehouseStorage(Base):
	__tablename__ = 'WarehouseStorage'
	warehouseID = Column('warehouseID', Integer(20), ForeignKey("Warehouse.warehouseID"), primary_key=True)

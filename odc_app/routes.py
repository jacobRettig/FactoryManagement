...
"""
TODO for Salem:
    - Create a page for a failed login @app.errorhandler(401).
    - Remember that our usernames are emails.
    - Create a links for logout.
    - Create a page for unauthorized login @login_manager.unauthorized_handler
    - Include address on register page.
"""
